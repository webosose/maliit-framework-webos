...
namespace Maliit {
    ...
    /*!
     * \brief Enter key type for its purpose
     *
     * Enter key type of the VKB, which can be used by
     * input method plugins to offer more specific "Enter" key label, such as a
     * "Search" key for search applications.
     */
    enum EnterKeyType {
        //! The default Enter key. In normal case, it will show "Enter"
        DefaultEnterKeyType,
        ...
        //! Show a "Search" button. Typically used by searching application, etc.
        SearchEnterKeyType,

        //! Show a "Next" button. Typically used in a form to allow navigating to the next input field.
        NextEnterKeyType,
...
Q_DECLARE_METATYPE(Maliit::EnterKeyType)
