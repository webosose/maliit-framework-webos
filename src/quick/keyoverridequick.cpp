                                     ...
                                     const MKeyOverride::KeyOverrideAttributes changedAttributes)
{
    ...
    if (keyOverride)
    {
        ...
        if (not keyOverride->icon().isEmpty()) {
            ...
            qCritical() << "Both label and icon have no default value.";
        }
    ...
    case UseActual:
        break;
    default:
        qCritical() << "unknown enum value for iconAction:" << static_cast<int> (iconAction);
    }
    ...
    case UseActual:
        break;
    default:
        qCritical() << "unknown enum value for labelAction:" << static_cast<int> (labelAction);
    }
}
